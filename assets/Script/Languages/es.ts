export const ES = {
    ...
    TranslatorName:
        "Juan Manuel Jaén Cabrera (Leunal17), Dishito, Daniel Padilla Rodríguez (danpad01), robertomd, MrGat0s, g0nkz",
    Language: "Idioma",
    ...
    PlayerCountryChooseFlag: "En orden alfabético por codigo de país",
    ...
    ResourceExplorerDesc: "Permite extraer recursos de una casilla vacía",
    ...
    FirstTimeReadGuide: "💡 ¿Necesitas ayuda sobre cómo jugar? Cliquea aquí para leer la guía para principiantes.",
    ...
    LeaderboardDescV2: "Ver la clasificación de jugadores",
    ...
    EBookInc: "eBook Inc",
    ResourceBooster: "Impulso de Recursos",
    ...
    ResourceBoosterDesc: "Aumenta la producción de las minas adyacentes",
    ...
    AtomicBombFactory: "Fábrica de Bombas Atómicas",
    ...
    LiquidPropellantFactory: "Fábrica de Propulsor Líquido",
    GasPropellantFactory: "Fábrica de Propulsor Gaseoso",
    Propellant: "Propellant",
    ProjectV2: "Project V-2",
    ICBMFactory: "ICBM Factory",
    ICBM: "ICBM",
    RadarFactory: "Fábrica de Radares",
    Radar: "Radar",
    ...
    GetHelpSteamGuides: "Otras Guías en Steam",
    GetHelpInGameChat: "Chat en Juego",
    GetHelpDiscord: "Únete a nuestro Servidor de Discord",
    GetHelpWiki: "Wiki Comunitaria",
    ...
    PatchNotesDesc: "Leer qué hay de nuevo en esta actualización",
    ...
    IndustryZone: "Sector Industrial",
    IndustryZoneDesc: "Combinar edificios adyacentes para formar una cadena de suministros y ahorrar en permisos de construcción",
    ...
    SuperComputerLab: "Laboratorio de Super Computadoras",
    SuperComputer: "Super Computadora",
    ...
    GalvanicBatteryFactory: "Fábrica de Baterías Galvánicas",
    ...
    BatteryRecycler: "Recicladora de baterías",
    ...
    AccountVerification: "Verificación",
    ...
    QuantumComputerLab: "Laboratorio de Computo Cuántico",
    ...
    OnlyShowPositiveModifiers: "Mostrar solo modificadores positivos",
    ...
    GameSetting: "Ajustes",
    GameSettingDesc: "Configura el juego a tus necesidades",
